$(document).ready(function(){
    ...
    // 메인 비주얼 슬라이드
    // .num 의 li에 클릭이벤트 설정( 01, 02, 03 버튼)
    $('.num ul li').click(function(){
        ...
        // 클릭한 li의 후손a태그를 찾아서 active 클래스 추가 
    ...
    var sw=0; //스위치변수(버튼1개 클릭할 때마다 상태가 변할 때 사용함)
    ...
    //  자동 슬라이드에 마우스오버했을 떄 멈추고, 마우스 아웃했을 때 다시 자동 슬라이드 됨
